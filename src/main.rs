...
type Server = Recv<Vec<u8>, Send<Vec<u8>, Recv<Vec<u8>, Eps>>>;
...
fn srv(c: Chan<(), Server>, info: KeyStorage) {
...
fn cli(c: Chan<(), Client>, info: KeyStorage) {
    // Choose a connection identifier
